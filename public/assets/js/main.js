...
(function ($) {
    ...
    /*---products slick column5 activation---*/
    ...
    /*---products slick column4 activation---*/
    ...
    /*---products deals column4 activation---*/
    ...
    /*---single products activation---*/
    $('.single-products-active').owlCarousel({
        autoplay: true,
		loop: true,
        nav: true,
        autoplay: false,
    ...
    $('.product_navactive a').on('click',function(e){
      ...
      $('.products-details-large .tab-pane').removeClass('active show');
      $('.products-details-large '+ $href ).addClass('active show');
    ...
    $('#gallery_01').owlCarousel({
        ...
        onInitialized: function() {
            $('#gallery_01 a').on('click', function(e) {
                ...
                $('#zoom1').attr('src', zoomImage);
                $('#zoom1').data('zoom-image', zoomImage);
                $('#zoom1').elevateZoom({
                    gallery: 'gallery_01',
                    responsive: true,
                    cursor: 'crosshair',
